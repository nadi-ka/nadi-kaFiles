...
public class Predators extends Animals {
    ...
    protected ArrayList <String> foods = new ArrayList<>(Arrays.asList("meat", "fish", "poultry", "cutlets"));
    ...
    public void isFoodGoodForThisAnimal(ArrayList<String> foods) {
        ...
        System.out.println("What do you want to give me?");
    ...
    public void predatorIsHunting (){
        System.out.println("Predator has just catched a prey!");
    }
}
