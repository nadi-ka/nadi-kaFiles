package by.epam.trjava.connect;

import by.epam.trjava.connect.resourceManager.DBParameter;
import by.epam.trjava.connect.resourceManager.ResourceManager;
import java.sql.*;
...
public final class ConnectionPool {
    ...
    private void clearConnectionQueue() {
        try {
            ...
            //Here'll be a logger.log(Level.ERROR, "Error during closing the connection", e);
        }
    }
    ...
    public void closeConnection(Connection connection, Statement statement, ResultSet resultSet) {
        try {
            ...
            //Logger.log(Level.Error, "Connection wasn't returned to the pool", ex);
        }
        try {
            resultSet.close();
        } catch (SQLException ex) {
            //Logger.log(Level.Error, "ResultSet wasn't closed", ex);
        }
        try {
            statement.close();
        } catch (SQLException ex) {
            //Logger.log(Level.Error, "Statement wasn't closed", ex);
        }
    }
