	...
	<c:forEach var="elem" items="${treatment}">
		...
		<table>
			...
			<tr>
				...
				<td><c:out value="${treatment.doctorSurname}" /><br> <c:out
						value="${treatment.doctorName}" /></td>
				...
				<td>
					<form name="consentForm" method="POST" action="register">
						<input type="hidden" name="command" value="getConsent" /> <input
							type="radio" name="consent" value="agree"> <input
							type="radio" name="consent" value="don't agree">
					</form>
				</td>
			</tr>
		</table>
