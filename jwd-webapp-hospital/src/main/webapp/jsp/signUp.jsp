...
<body>
	...
	<form name="registerForm" method="POST" action="register">
		...
		<fieldset>
			...
			</label> <label>E-mail: <input type="email" name="email"><br />
			</label> <input type="radio" name="type-of-user" value="patient"> <input
				type="radio" name="type-of-user" value="medical-staff"> <br />
			${errorRegistrationDada} <br /> ${wrongAction} <br /> ${nullPage} <br />
